...
import Banks from 'src/views/pages/directory/BankList'
import BankBranch from 'src/views/pages/directory/BankBranches'
...
const BankTab = () => {
  ...
  const handleChange = (event: SyntheticEvent, value: string) => {
    ...
    router
      .push({
        pathname: `/directory/banks/${value.toLowerCase()}`
      })
            ...
            <Tab
              ...
              label={
                <StyledBadge badgeContent={lenginActive} color='primary' sx={{ pr: 6 }}>
                  <Translations text='branch_banks' />
                </StyledBadge>
              }
            />
          </TabList>
