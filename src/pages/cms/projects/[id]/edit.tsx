                    ...
                    <Autocomplete<any, true, false, false>
                      ...
                      value={
                        Array.isArray(field.value)
                          ? (industries.filter((i: any) => (field.value as number[]).includes(i.id)) as any[])
                          : []
                      }
                ...
                render={({ field }) => {
                  ...
                  return (
                    <Autocomplete<any, true, false, false>
                      ...
                      value={
                        Array.isArray(field.value)
                          ? (equipmentCategories.filter((i: any) => (field.value as number[]).includes(i.id)) as any[])
                          : []
                      }
                      onChange={(_, value: any[]) => field.onChange(value.map((v: any) => v.id))}
                ...
                render={({ field }) => {
                  ...
                  return (
                    <Autocomplete<any, true, false, false>
                      ...
                      value={
                        Array.isArray(field.value)
                          ? (partners.filter((i: any) => (field.value as number[]).includes(i.id)) as any[])
                          : []
                      }
                      onChange={(_, value: any[]) => field.onChange(value.map((v: any) => v.id))}
