...
const NewsCreatePage = () => {
  ...
  const { control, handleSubmit, setValue, formState: { isSubmitting } } = useForm({ defaultValues })
  ...
  const onSubmit = async (values: any) => {
    ...
    try {
      await DataService.postForm(endpoints.news, formData)
      toast.success('Yangilik muvaffaqiyatli qo‘shildi!')
      router.push('/cms/news')
    } catch (e) {
      toast.error('Yangilik qo‘shishda xatolik!')
    }
  }

  return (
    <Card>
      <CardHeader title='Yangi yangilik qo‘shish' />
...
NewsCreatePage.acl = { action: 'create', subject: 'cms' }
NewsCreatePage.authGuard = true
