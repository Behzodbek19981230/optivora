...
const CompanyProfileForm = ({ initialValues, onSubmit, loading }: Props) => {
  ...
  return (
    <Card>
      <CardHeader
        title={initialValues?.id ? 'Kompaniya maʼlumotlarini tahrirlash' : 'Kompaniya maʼlumotlarini qo‘shish'}
      />
          ...
          <Grid container spacing={4}>
            ...
            <Grid item xs={12} md={3}>
              <Controller
                name='email'
                control={control}
                render={({ field }) => <CustomTextField fullWidth label='Email' {...field} />}
              />
            </Grid>
            <Grid item xs={12} md={3}>
              <Controller
            ...
            <Grid item xs={12} md={3}>
              <Controller
                name='business_hours'
                control={control}
                render={({ field }) => <CustomTextField fullWidth label='Ish vaqti' {...field} />}
              />
            </Grid>
            <Grid item xs={12} md={4}>
              <Controller
                name='title_uz'
                control={control}
                render={({ field }) => <CustomTextField fullWidth label='Lavozim (UZ)' {...field} />}
              />
            </Grid>
            <Grid item xs={12} md={4}>
              <Controller
                name='title_en'
                control={control}
                render={({ field }) => <CustomTextField fullWidth label='Lavozim (EN)' {...field} />}
              />
            </Grid>
            <Grid item xs={12} md={4}>
              <Controller
                name='title_ru'
                control={control}
                render={({ field }) => <CustomTextField fullWidth label='Lavozim (RU)' {...field} />}
              />
            </Grid>
            <Grid item xs={12} md={4}>
              <Controller
                name='title_lt'
                control={control}
                render={({ field }) => <CustomTextField fullWidth label='Lavozim (LT)' {...field} />}
              />
            </Grid>
            ...
            <Grid item xs={12} md={4}>
              <Controller
                name='description_uz'
                control={control}
                render={({ field }) => <CustomTextField fullWidth multiline rows={4} label='Tavsif (UZ)' {...field} />}
              />
            </Grid>
            <Grid item xs={12} md={4}>
              <Controller
                name='description_en'
                control={control}
                render={({ field }) => <CustomTextField fullWidth multiline rows={4} label='Tavsif (EN)' {...field} />}
              />
            </Grid>
            <Grid item xs={12} md={4}>
              <Controller
                name='description_ru'
                control={control}
                render={({ field }) => <CustomTextField fullWidth multiline rows={4} label='Tavsif (RU)' {...field} />}
              />
            </Grid>
            <Grid item xs={12} md={4}>
              <Controller
