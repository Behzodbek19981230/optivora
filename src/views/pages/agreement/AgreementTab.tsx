...
import Confirmation from './agreementTab/confirmation/confirmation'
import Collection from './agreementTab/collection/collection'
interface Data {
  email: string
  state: string
  address: string
...
const AgreementTabMain = ({ tab }: any) => {
  // ** State
...
export default AgreementTabMain
