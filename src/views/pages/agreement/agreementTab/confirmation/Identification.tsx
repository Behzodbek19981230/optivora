...
const IdentificationListTabApprove = ({ refresh }: { refresh: string }) => {
  ...
  const onExport = async () => {
    ...
    const res = await DataService.get(endpoints.applicationApprovedFilter, {
      ...params,
      status: StatusesEnum.identification,
      search: value,
      page: 1,
...
export default IdentificationListTabApprove
